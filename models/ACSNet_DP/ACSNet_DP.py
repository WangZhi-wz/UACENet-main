...
from models.ACSNet_DP.modules import LCA, GCM, ASM, LCA3, LCA4, LCA2, LCA1, DP4, DP3, DP2, DP1
...
class ACSNet_DP(nn.Module):
    def __init__(self, num_classes):
        super(ACSNet_DP, self).__init__()
        ...
        self.dp4 = DP4(256, Norm2d)
        self.dp3 = DP3(128, Norm2d)
        self.dp2 = DP2(64, Norm2d)
        self.dp1 = DP1(64, Norm2d)
    ...
    def forward(self, x):
        ...
        edge1 = self.dp1(e1)
        # edge1 = self.outconv1(edge1)
        gc1 = global_contexts[3]
        comb1 = self.asm1(edge1, d2, gc1)
