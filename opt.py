...
"-------------------data option--------------------------"
parse.add_argument('--root', type=str, default= r'D:/datasets/poly_dataset/Kvasir1')
# D:/datasets/poly_dataset/kvasir-SEG
# C:\Users\15059\Desktop\kvasir-SEG-CAM
# Kvasir1 CVC_ClinicDB piccolo kvasir-SEG CVC-ColonDB ETIS-LaribPolypDB
parse.add_argument('--dataset', type=str, default='kvasir_SEG')     # kvasir_SEG CVC_ClinicDB piccolo esophagus
...
parse.add_argument('--model', type=str, default='ACSNet_caRABAsaBD_modDCR')
# ACSNet_DP
# ACSNet  ACSNet_double ACSNet_modGCM ACSNet_noGCM ACSNet_vipattention ACSNet_APF ACSNet_modASM
...
parse.add_argument('--expName', type=str, default='ACSNet_caRABAsaBD_modDCR')
