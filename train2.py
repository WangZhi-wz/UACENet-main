...
def test(model, test_dataloader, total_batch):
    ...
    with torch.no_grad():
        ...
        test_loss_all = test_loss/opt.count
...
def valid(model, valid_dataloader, total_batch):
    ...
    with torch.no_grad():
        ...
        val_loss_all = val_loss/opt.count
...
def train():
    ...
    # macs, params = profile(model, inputs=(input, 'train'))
    macs, params = profile(model, inputs=(input, ))
    print('GFLOPs:',macs/1000000000)
    print('params:',params/1000000)
    # logger.info(f"| model |GFLOPs:', {macs/1000000000}, 'params:', {params/1000000}|")
