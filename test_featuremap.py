...
class ResNet(nn.Module):
    def __init__(self, num_classes=14):  # num_classes，此处为 二分类值为2
...
# 1.将输入图片转成tensor的形式
image_info = get_image_info(r"C:\Users\15059\Desktop\best_model\Kvasir-SEG-image-result1\image\0.jpg")
